...
const UploadPage = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <Card className="mb-8">
        <h1 className="text-2xl font-bold text-gray-800 mb-6">Upload & Share Files</h1>
        <FileUploader onFileSelect={handleUpload} progress={progress} isUploading={uploading} />
      </Card>
            ...
            <div className="mt-4">
              ...
              {!isIdValid && (
                <p className="text-sm text-red-500 mt-1">
                  Invalid ID. Only letters, numbers, hyphens, and underscores are allowed.
                </p>
              )}
            </div> */}
          </motion.div>
